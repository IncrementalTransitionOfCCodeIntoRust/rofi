...
pub type WidgetTriggerActionCB = Option<fn(wid: Box<_widget>, action: u16, x: i16, y: i16, user_data: Option<Box<dyn Any>>) -> WidgetTriggerActionResult>;
...
pub struct _widget {
    ...
    pub end: bool,
    /** Parent _widget */
    pub parent: Option<Box<_widget>>,
    /** Internal */
    pub need_redraw: bool,
    /** get width of _widget implementation function */
    pub get_width: Option<fn(Box<_widget>) -> i16>,
    /** get height of _widget implementation function */
    pub get_height: Option<fn(Box<_widget>) -> i16>,
    /** draw _widget implementation function */
    pub draw: Option<fn(widget: Box<_widget>, draw: *mut cairo_t) -> ()>,
    /** resize _widget implementation function */
    pub resize: Option<fn(Box<_widget>, i16, i16) -> ()>,
    /** update _widget implementation function */
    pub update: Option<fn(Box<_widget>) -> ()>,

    /** Handle mouse motion, used for dragging */
    pub motion_notify: Option<fn(Box<_widget>, x: i16, y: i16) -> bool>,

    pub get_desired_height: Option<fn(Box<_widget>) -> i16>,
    pub get_desired_width: Option<fn(Box<_widget>) -> i16>,

    pub set_state: Option<fn(Box<_widget>, String) -> ()>,  // String was const

    /** _widget find_mouse_target callback */        // TODO tranlate
    pub find_mouse_target: Option<fn(wid: Box<_widget>,_type: WidgetType, x: i16, y: i16) -> Option<Box<_widget>>>,
    ...
    //pub trigger_action: Option<fn(wid: Box<_widget>, action: u16, x: i16, y: i16, data: Option<libc::c_int>) -> WidgetTriggerActionResult>,

    /** Free _widget callback */
    pub free: fn(widget: Box<_widget>) -> (),
